        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("StaffDashboard", "AdminDashboard"); // Redirect to Staff dashboard
                    }
                    else if (UserManager.IsInRole(user.Id, "Recruiter"))
                    {
                        return RedirectToAction("Dashboard", "Jobs"); // Redirect to Recruiter dashboard
                    }
